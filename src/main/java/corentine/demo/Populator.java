...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Exercise bentOverRow = new Exercise("Bent Over Row", "/images/tricepsChairDip.gif", "While holding jugs at your side, with your legs bent slightly keep your back straight and bend over until your upper body is almost perpendicular with the floor. Once in position lift the jugs into your chest and return them to the starting position. Repeat up to 20 times.",10, 10, 60, jugs);
        Exercise jugClean = new Exercise("Jug Clean", "/images/tricepsChairDip.gif", "Place the jugs at your feet. Bend your knees and grasp them. Lift the jugs to your shoulders and then stand up. Once in a standing position, lift the jugs above your head and hold them there for a second. Reverse the motion and return the jugs to the floor. Repeat up to 20 times.", 10, 10, 60, jugs);
